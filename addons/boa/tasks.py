...
async def submit_to_boa_async(host, username, password, user_guid, project_guid, query_dataset,
    ...
    try:
        ...
        await sync_to_async(handle_error)(message, BoaErrorCode.UNKNOWN, user.username, user.fullname, project_url,
                                          file_full_path, output_file_name, query_file_name=query_file_name)
        return
    ...
    if boa_job.compiler_status is CompilerStatus.ERROR:
        ...
        await sync_to_async(handle_error)(message, BoaErrorCode.QUERY_ERROR, user.username, user.fullname,
                                          project_url, file_full_path, output_file_name,
...
def handle_error(message, code, username, fullname, project_url,
                 query_file_full_path, output_file_name, query_file_name=None, job_id=None):
